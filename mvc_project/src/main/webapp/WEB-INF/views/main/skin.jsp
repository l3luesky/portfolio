    ...
    <div id="dkHead" role="banner" class="area_head">
        ...
        <div class="area_profile">
            ...
            <span class="thumb_profile">
                <img src="[##_image_##]" class="img_profile" alt="íë¡íì¬ì§">
            </span>
        ...
        <div id="cMain">
            <div id="mFeature" class="wrap_sub">
                <div class="cont_sub">
                    ...
                    <ul class="list_control">
                        <li><a href="[##_owner_url_##]/entry/post" class="ico_skin link_write" title="ê¸ì°ê¸°">ê¸ì°ê¸°</a></li>
                        <li><a href="[##_guestbook_link_##]" class="ico_skin link_memo" title="ë°©ëªë¡">ë°©ëªë¡</a></li>
                        <li><a href="[##_rss_url_##]" class="ico_skin link_rss" title="RSS">RSS</a></li>
                        <li><a href="[##_owner_url_##]" class="ico_skin link_manage" title="ê´ë¦¬">ê´ë¦¬</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div id="mArticle" class="article_skin">
				...
				<div class="list_title">
					<h2 id="dkBody" class="tit_skin"><span class="screen_out">ëª©ë¡</span><span class="txt_title">[##_list_conform_##] ([##_list_count_##])</span></h2>
				</div>
				</s_list>
                    ...
                    <s_permalink_article_rep>
                        ...
                        <div class="area_title">
                            ...
                            <span class="info_post">[##_article_rep_author_##]
								...
								<s_ad_div>
									<span class="txt_bar"></span><a href="[##_s_ad_m_link_##]" class="link_detail">ìì </a>
									<span class="txt_bar"></span><a href="#" onclick="[##_s_ad_s2_onclick_##]" class="link_detail">[##_s_ad_s1_label_##]</a>
									<span class="txt_bar"></span><a href="#" onclick="[##_s_ad_d_onclick_##]" class="link_detail">ì­ì </a>
								</s_ad_div>
							</span>
                        </div>
                        ...
                        <div class="area_etc">
                            ...
                            <ul class="list_share">
                                <li><a href="#none" class="ico_skin link_fb" data-service="facebook">íì´ì¤ë¶</a></li>
                                <li><a href="#none" class="ico_skin link_ks" data-service="kakaostory">ì¹´ì¹´ì¤ì¤í ë¦¬</a></li>
                                <li><a href="#none" class="ico_skin link_tw" data-service="twitter">í¸ìí°</a></li>
                            </ul>
                        </div>
                                    ...
                                    <s_rp_rep>
                                        <li id='[##_rp_rep_id_##]' class="[##_rp_rep_class_##]">
                                            <span class="ico_skin thumb_profile">
												<img src="//i1.daumcdn.net/thumb/C96x96/?fname=[##_rp_rep_logo_##]" width="48" height="48" class="img_profile" alt="íë¡íì¬ì§">
											</span>
                                            ...
                                            <div class="area_more">
                                                ...
                                                <a href="#none" class="more_reply">
                                                    <span class="ico_skin ico_more">ëê¸ ë©ë´ ë³´ê¸°</span>
                                                </a>
                                                <div class="reply_layer">
                                                    <div class="inner_reply_layer">
                                                        ...
                                                        <div class="layer_body">
                                                            ...
                                                            <a href="#none" onclick="[##_rp_rep_onclick_delete_##]" class="link_reply">ìì /ì­ì </a>
                                                            <a href="#none" onclick="[##_rp_rep_onclick_reply_##]" class="link_reply">ëê¸ì°ê¸°</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <s_rp_input_form>
                                    <fieldset class="fld_reply">
        									...
        									<s_rp_guest>
                                                <div class="writer_info">
                                                    <span class="info_name">
                                                        <label for="[##_rp_input_name_##]" class="lab_info screen_out">ì´ë¦</label>
                                                        <span class="wrap_info">
                                                            <input type="text" name="[##_rp_input_name_##]" id="[##_rp_input_name_##]" class="inp_info" placeholder="Name" tabindex="1">
                                                        </span>
                                                    </span>
                                                    <span class="info_pw ">
                                                        <label for="[##_rp_input_password_##]" class="lab_info screen_out">ë¹ë°ë²í¸</label>
                                                        <span class="wrap_info">
                                        ...
                                        <div class="reply_write ">
                                            ...
                                            <textarea name="[##_rp_input_comment_##]" id="[##_rp_input_comment_##]" class="tf_reply" placeholder="ì¬ë¬ë¶ì ìì¤í ëê¸ì ìë ¥í´ì£¼ì¸ì" tabindex="3"></textarea>
                                        </div>
				...
				<s_article_protected>
					...
					<s_permalink_article_rep>
						...
						<form class="protected_form" onsubmit="[##_article_dissolve_##]">
							<p>ë³´í¸ëì´ ìë ê¸ìëë¤.<br>ë´ì©ì ë³´ìë ¤ë©´ ë¹ë°ë²í¸ë¥¼ ìë ¥íì¸ì.</p>
							<input type="password" id="[##_article_password_##]" name="[##_article_password_##]" value="" placeholder="ë¹ë°ë²í¸" />
							...
							<fieldset class="fld_reply">
								...
								<s_guest_member>
									<s_guest_form>
										<div class="writer_info">
											<span class="info_name">
												<label for="[##_guest_input_name_##]" class="lab_info screen_out">ì´ë¦</label>
												<span class="wrap_info">
													<input type="text" name="[##_guest_input_name_##]" id="[##_guest_input_name_##]" class="inp_info" placeholder="Name" tabindex="1">
												</span>
											</span>
											<span class="info_pw ">
												<label for="[##_guest_input_password_##]" class="lab_info screen_out">ë¹ë°ë²í¸</label>
												<span class="wrap_info">
								...
								<div class="reply_write ">
									<label for="[##_guest_input_comment_##]" class="lab_write screen_out">ë´ì©</label>
									<textarea name="[##_guest_input_comment_##]" id="[##_guest_input_comment_##]" class="tf_reply" placeholder="ì¬ë¬ë¶ì ìì¤í ëê¸ì ìë ¥í´ì£¼ì¸ì" tabindex="3"></textarea>
								</div>
									...
									<div class="area_more">
										...
										<div class="reply_layer">
											<div class="inner_reply_layer">
												...
												<div class="layer_body">
													<a href="#none" onclick="[##_guest_rep_onclick_delete_##]" class="link_reply">ìì /ì­ì </a>
													<a href="#none" onclick="[##_guest_rep_onclick_reply_##]" class="link_reply">ëê¸ì°ê¸°</a>
												</div>
											</div>
										</div>
									</div>

...
<head>
    ...
    <link href="resources/css/uploadView.css" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="support.do" class="nav-item nav-link">Support</a>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        ...
                        <a href="#" class="dropdown-item">문의 내역</a>
                    </div>
                </div>
            </div>
            <a href="signup.do" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">로그인<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container">
        ...
        <div id="button-container">
            <button onclick="history.back()" class="submitButton">Back</button>
            <button onclick="window.open('이미지 URL')" class="submitButton">Download</button>
            <button class="submitButton">Compare</button>
        </div>
    </div>

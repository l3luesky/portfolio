		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav ms-auto p-4 p-lg-0">
				<a href="index.do" class="nav-item nav-link">Home</a> <a
					...
					href="http://211.228.63.230:8501" class="nav-item nav-link">Service</a> <a
				...
				<c:choose>
					<c:when test="${session.mem_id.equalsIgnoreCase('admin@admin.com')}">
						<div class="top">
							...
							<div class="response">답변여부</div>
						</div>
						<c:forEach var="vo" items="${conList}">
							<div class="num">${vo.con_num}</div>
							<div class="title">${vo.con_title}</div>
							<div class="date">${vo.con_date}</div>
							<div class="response">${vo.con_replyCheck}</div>
							<div class="response">
								<a href="goReply.do?con_num=${vo.con_num}">답변</a>
							</div>
						</c:forEach>
			</div>
			</c:when>

          ...
          <div class="insert">
              <table>
                  <tr>
                      ...
                      <td class="col2"><input type="text" name="mem_name" maxlength="5" value="${session.mem_name}"/></td>
                  </tr>
                  <tr>
                      <td class="col1">비밀번호</td>
                      <td class="col2">
                          <input type="password" name="mem_pw" maxlength="16" value="${session.mem_pw}"/>
                  ...
                  <tr>
                  	<td class="col1">주소</td>
                  	<td><input type="text" name="mem_addr" value="${session.mem_addr}"></td>
                  </tr>
                  <tr>
                  	<input type="hidden" name="mem_num" value="${session.mem_num}"/>
                  	<td class="col1">전화번호</td>
                  	<td><input type="text" name="mem_tel" value="${session.mem_tel}"></td>
                  </tr>
              </table>
          </div>
          <div class="create">
